...
macro(_INDI_check_version)
    ...
    # INDI 1.9.x may use a different indiversion.h format; fall back to pkg-config version if header parse failed
    if(NOT INDI_VERSION OR INDI_VERSION MATCHES "^\\.|\\.\\.|\\.$")
        if(PC_INDI_VERSION)
            set(INDI_VERSION "${PC_INDI_VERSION}")
        endif()
    endif()
    if(NOT INDI_VERSION)
        set(INDI_VERSION "0.0.0")
        set(INDI_VERSION_OK FALSE)
    elseif(${INDI_VERSION} VERSION_LESS ${INDI_FIND_VERSION})
        set(INDI_VERSION_OK FALSE)
