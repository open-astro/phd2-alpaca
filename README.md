...
This repository contains an OpenAstro-maintained build derived from PHD2 that is **focused on Alpaca support only**. It is intended for use with [**AlpacaBridge**](https://github.com/open-astro/AlpacaBridge) and related Alpaca-based workflows.
